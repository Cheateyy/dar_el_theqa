...
export function FilterCombobox({ className, options = [], filtername, input_control }) {
    if (input_control) {
        return <ControlledFilterCombobox className={className} options={options} filtername={filtername} input_control={input_control} />
    }
    else {
        return <UncontrolledFilterCombobox className={className} options={options} filtername={filtername} />
    }
}

function ControlledFilterCombobox({ className, options, filtername, input_control }) {
...
function UncontrolledFilterCombobox({ className, options, filtername, }) {
    const [open, setOpen] = useState(false)
